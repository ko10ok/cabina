...
class TransparentEnvironment:
    ...
    def __init__(self, environ: Mapping[str, str] = os.environ, *, prefix: str = "") -> None:
        """
        Initialize the TransparentEnvironment instance with the given environment mapping
        and prefix.
    ...
    def __repr__(self) -> str:
        """
        Return a string representation of the TransparentEnvironment instance.

        :return: A string representation showing the environment mapping.
        """
        return f"cabina.TransparentEnvironment({self._environ!r})"
    ...
    def raw(self, name: str, default: Union[NilType, ValueType] = Nil,
        ...
        return cast(ValueType, FutureTransparentValue[ValueType](self.get, name, **kwargs))
